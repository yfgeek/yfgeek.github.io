...
<head>
  ...
  <title>常用Bash命令总结</title>
  
  
  <meta property="og:title" content="常用Bash命令总结">
  
  
  <meta property="og:url" content="http://www.yfgeek.com/bash">
  
  
  <meta property="og:img" content="/content/images/blog/me.jpg">
  
  
  <meta property="og:img" content="&lt;p&gt;自从入了Mac后，感觉敲命令更加方便了，对于我这种半吊子青年，一直号称不会写脚本的前端不是好美工，总结了一些命令，仅供参考，省去了最简单的命令，不过部分也比较简单：&lt;/p&gt;">
  
  
  <meta property="og:type" content="article">
  <meta property="og:article:published_time" content="2016-08-06">
  <meta property="og:article:modified_time" content="2016-08-06">
...
<article class="card card-content">
  ...
  <div class="post-meta post-show-meta">
    <time datetime="2016-08-06T00:36:19.000Z">
  ...
  <div id="section" class="post-content">
    <p>自从入了Mac后，感觉敲命令更加方便了，对于我这种半吊子青年，一直号称不会写脚本的前端不是好美工，总结了一些命令，仅供参考，省去了最简单的命令，不过部分也比较简单：</p>
<span id="more"></span> 
...
<h2 id="一句话命令"><a href="#一句话命令" class="headerlink" title="一句话命令"></a>一句话命令</h2><p>脚本中切换用户</p>
<pre class="highlight"><span class="line">su - <span class="built_in">test</span> -c <span class="string">&quot;pwd&quot;</span></span><br></pre>

<p>连接到你服务器端口的ip</p>
<pre class="highlight"><span class="line">netstat -tun|grep 7890|sort|awk <span class="string">&#x27;&#123;print $5&#125;&#x27;</span>|cut -d : -f 1|uniq </span><br></pre>
<h2 id="常用功能"><a href="#常用功能" class="headerlink" title="常用功能"></a>常用功能</h2><h2 id="定时任务"><a href="#定时任务" class="headerlink" title="#定时任务"></a>#定时任务</h2><p>使用-l参数列出crontab文件:</p>
<pre class="highlight"><span class="line">crontab -l</span><br></pre>
<p>编辑crontab文件</p>
<pre class="highlight"><span class="line">crontab -e</span><br></pre>
<p>实例1：每1分钟执行一次myCommand</p>
<pre class="highlight"><span class="line">* * * * * myCommand</span><br></pre>
<p>实例2：每小时的第3和第15分钟执行</p>
<pre class="highlight"><span class="line">3,15 * * * * myCommand</span><br></pre>
<p>实例3：在上午8点到11点的第3和第15分钟执行</p>
<pre class="highlight"><span class="line">3,15 8-11 * * * myCommand</span><br></pre>
<p>实例4：每隔两天的上午8点到11点的第3和第15分钟执行</p>
<pre class="highlight"><span class="line">3,15 8-11 */2  *  * myCommand</span><br></pre>
<p>实例5：每周一上午8点到11点的第3和第15分钟执行</p>
<pre class="highlight"><span class="line">3,15 8-11 * * 1 myCommand</span><br></pre>
<p>实例6：每晚的21:30重启smb</p>
<pre class="highlight"><span class="line">30 21 * * * /etc/init.d/smb restart</span><br></pre>
<p>实例7：每月1、10、22日的4 : 45重启smb</p>
<pre class="highlight"><span class="line">45 4 1,10,22 * * /etc/init.d/smb restart</span><br></pre>
<p>实例8：每周六、周日的1 : 10重启smb</p>
<pre class="highlight"><span class="line">10 1 * * 6,0 /etc/init.d/smb restart</span><br></pre>
<p>实例9：每天18 : 00至23 : 00之间每隔30分钟重启smb</p>
<pre class="highlight"><span class="line">0,30 18-23 * * * /etc/init.d/smb restart</span><br></pre>
<p>实例10：每星期六的晚上11 : 00 pm重启smb</p>
<pre class="highlight"><span class="line">0 23 * * 6 /etc/init.d/smb restart</span><br></pre>
<p>实例11：每一小时重启smb</p>
<pre class="highlight"><span class="line">* */1 * * * /etc/init.d/smb restart</span><br></pre>
<p>实例12：晚上11点到早上7点之间，每隔一小时重启smb</p>
<pre class="highlight"><span class="line">* 23-7/1 * * * /etc/init.d/smb restart</span><br></pre>
<h2 id="scp"><a href="#scp" class="headerlink" title="#scp"></a>#scp</h2><p>实例1：从远处复制文件到本地目录</p>
<pre class="highlight"><span class="line">scp root@10.6.159.147:/opt/soft/demo.tar /opt/soft/</span><br></pre>
<p>说明：从10.6.159.147机器上的/opt/soft/的目录中下载demo.tar 文件到本地/opt/soft/目录中</p>
<p>实例2：从远处复制到本地</p>
<pre class="highlight"><span class="line">scp -r root@10.6.159.147:/opt/soft/<span class="built_in">test</span> /opt/soft/</span><br></pre>
<p>说明：从10.6.159.147机器上的/opt/soft/中下载test目录到本地的/opt/soft/目录来。</p>
<p>实例3：上传本地文件到远程机器指定目录</p>
<pre class="highlight"><span class="line">scp /opt/soft/demo.tar root@10.6.159.147:/opt/soft/scptest</span><br></pre>
<p>说明：复制本地opt/soft/目录下的文件demo.tar 到远程机器10.6.159.147的opt/soft/scptest目录</p>
<p>实例4：上传本地目录到远程机器指定目录</p>
<pre class="highlight"><span class="line">scp -r /opt/soft/<span class="built_in">test</span> root@10.6.159.147:/opt/soft/scptest</span><br></pre>
...
<div class="nav">
  ...
  <div class="nav-item-prev">
    <a href="/2016/08/07/用树莓派把蓝牙音响变成Airplay音响/" class="nav-link">
      <i class="iconfont icon-left nav-prev-icon"></i>
      <div>
        <div class="nav-label">上一篇</div>
        
        <div class="nav-title">用树莓派把蓝牙音响变成Airplay音响 </div>
  ...
  <div class="nav-item-next">
    <a href="/2016/08/01/Kali系列——信息收集阶段（二）/" class="nav-link">
      <div>
        <div class="nav-label">下一篇</div>
        
        <div class="nav-title">Kali系列——信息收集阶段（二） </div>
...
<ol class="toc"><li class="toc-item toc-level-2"><a class="toc-link" href="#%E6%97%A5%E5%B8%B8"><span class="toc-text">日常</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#%E5%AE%89%E5%85%A8"><span class="toc-text">安全</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#%E4%B8%80%E5%8F%A5%E8%AF%9D%E5%91%BD%E4%BB%A4"><span class="toc-text">一句话命令</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#%E5%B8%B8%E7%94%A8%E5%8A%9F%E8%83%BD"><span class="toc-text">常用功能</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#%E5%AE%9A%E6%97%B6%E4%BB%BB%E5%8A%A1"><span class="toc-text">#定时任务</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#scp"><span class="toc-text">#scp</span></a></li></ol>
  ...
  <div class="tags-list">
    ...
    <a href="/tags/PaaS/" title="PaaS"><div class="tags-list-item">PaaS</div></a>
...
<ol class="toc"><li class="toc-item toc-level-2"><a class="toc-link" href="#%E6%97%A5%E5%B8%B8"><span class="toc-text">日常</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#%E5%AE%89%E5%85%A8"><span class="toc-text">安全</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#%E4%B8%80%E5%8F%A5%E8%AF%9D%E5%91%BD%E4%BB%A4"><span class="toc-text">一句话命令</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#%E5%B8%B8%E7%94%A8%E5%8A%9F%E8%83%BD"><span class="toc-text">常用功能</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#%E5%AE%9A%E6%97%B6%E4%BB%BB%E5%8A%A1"><span class="toc-text">#定时任务</span></a></li><li class="toc-item toc-level-2"><a class="toc-link" href="#scp"><span class="toc-text">#scp</span></a></li></ol>
  ...
  <div class="recent-posts-list">
      ...
      <div class="recent-posts-item">
        <div class="recent-posts-item-title">2020-09-28</div>
        <a href="/2020/09/28/在树莓派上编译运行GTA3/"><div class="recent-posts-item-content">在树莓派上编译运行GTA3</div></a>
      </div>
    
      <div class="recent-posts-item">
        <div class="recent-posts-item-title">2020-09-10</div>
        <a href="/2020/09/10/程序员生存指南之如何加固你的项目/"><div class="recent-posts-item-content">程序员生存指南之如何加固你的项目</div></a>
      </div>
    
      <div class="recent-posts-item">
        <div class="recent-posts-item-title">2019-05-18</div>
        <a href="/2019/05/18/NUC5i5RYH-Mojave-黑苹果安装手记/"><div class="recent-posts-item-content">NUC5i5RYH Mojave 黑苹果安装教程</div></a>
      </div>
